...
public class Triangle
{
    ...
    public Triangle(Point[] vertices)
    {
        if (vertices.Length != 3)
            throw new ArgumentException("В треугольнике должно быть ровно 3 вершины».");
...
class Program
{
    static void Main(string[] args)
    {
        ...
        Console.WriteLine("Объект треугольника сериализован и сохранен в файл: " + filePath);
        ...
        Console.WriteLine("Тип треугольника:: " + GetTriangleType(deserializedTriangle.Vertices));
    }
